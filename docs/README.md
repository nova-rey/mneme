...
* [Approved Phase Two self-conditioned developmental runtime plan](<Approved Plans/MNEME_Phase_Two_Self_Conditioned_Developmental_Runtime_Plan.md>)
  ...
  The [current-state refresh at `ad18b4f`](receipts/MNEME_Phase_Two_Current_State_Audit_20260926_ad18b4f.md)
  records the same scientific and accounting disposition after the offline
  engineering-audit closure, with 477-test validation and CI `36212795871`.
  ...
  The [minimal relationship extractor correction receipt](receipts/MNEME_P2_Contingent_Minimal_Relationship_Extractor_Correction_Receipt_20260924.md)
  ...
  all qualification monitors now serialize complete propositions. The subsequent
  ...
  The bounded recovery-v2 failure is recorded in [the recovery-v2 failure receipt](receipts/MNEME_P2.3_Pilot_Recovery_V2_Failure_20260924.md) ([JSON](receipts/MNEME_P2.3_Pilot_Recovery_V2_Failure_20260924.json)); strict validation stopped the run before evaluation.
...
* [Contingent conversation / interloper supplement](experiments/contingent-conversation/README.md)
  ...
  evidence; keyed edges with undeclared endpoints and unsupported keyed concept
  kinds are handled by the same item-level rule. The later `s1-e16` evidence
...
* The new prospective [P2.3 separated-support supplement v5 receipt](receipts/MNEME_P2.3_Separated_Support_Supplement_v5_Receipt_20260925.md) ([JSON](receipts/MNEME_P2.3_Separated_Support_Supplement_v5_Receipt.json)) and its [verbatim readable transcript](experiments/contingent-conversation/P2.3_Separated_Support_Supplement_v5_Transcript_20260925.md) record a perspective-correct, non-empty twelve-turn trajectory under Interloper contract revision 3 and relationships-v1. All twelve episodes were interpreted, but no qualifying separated-support consolidation transition occurred; historical P2.3 evidence and its `COMPLETED_INADEQUATE` disposition remain unchanged.

* The [P2.3 retrospective real-extraction v1 receipt](receipts/MNEME_P2.3_Retrospective_Real_Extraction_v1_Receipt_20260925.md) ([JSON](receipts/MNEME_P2.3_Retrospective_Real_Extraction_v1_Receipt_20260925.json)) records 12 new production Gemma extraction calls over the immutable v5 episodes. Every call returned a valid empty relationships-v1 set, so no assessment or learner state was created and the matched-twin readout was not run.

* The local MSI specialist-instrument setup and GLiNER2.5 benchmark are recorded in [the setup receipt](receipts/MNEME_MSI_Local_Inference_Setup_Receipt_20260925.md) and [the benchmark receipt](receipts/MNEME_P2.3_Specialist_Extractor_Benchmark_20260925.md). The derived [specialist reinterpretation receipt](receipts/MNEME_P2.3_Specialist_Reinterpretation_20260925.md), [assessment record](receipts/MNEME_P2.3_Specialist_Reinterpretation_Assessment_20260925.json), and [learner trace](receipts/MNEME_P2.3_Specialist_Reinterpretation_Trace_20260925.json) preserve the immutable v5 evidence while recording the candidate-observation instrument and downstream disposition.

* The matched-twin readout preflight is recorded in [the route-bound audit](receipts/MNEME_P2.3_Matched_Twin_AB_Preflight_20260925.md) ([machine-readable request/route evidence](receipts/MNEME_P2.3_Matched_Twin_AB_Preflight_20260925.json)). It is a blocked preflight, not an A/B result: the approved bounded route set contains no positive learner edge after collision variants consume the route slots, so no local readout calls were made.

* The superseding [route-view correction receipt](receipts/MNEME_P2.3_Matched_Twin_AB_Route_View_Correction_20260925.md) ([machine-readable corrected selection evidence](receipts/MNEME_P2.3_Matched_Twin_AB_Route_View_Correction_20260925.json)) records the read-only deduplication of collision variants before the unchanged `max_routes=8` bound. The corrected M/C probe audit has a meaningful treatment condition and authorizes the local readout step; no model calls are included in that correction receipt.

* The first local M/C readout attempt is preserved in [the reasoning-on stop receipt](receipts/MNEME_P2.3_Local_AB_Reasoning_On_Stop_20260925.md) ([raw sanitized results](receipts/MNEME_P2.3_Local_AB_Reasoning_On_Stop_20260925.json)). All eight llama.cpp processes exited successfully but spent the 96-token allowance in incomplete reasoning output; no usable readout response or developmental write was accepted.

* The fixed reasoning-off rerun is preserved in [the truncation receipt](receipts/MNEME_P2.3_Local_AB_Reasoning_Off_Truncated_20260925.md) ([raw sanitized results](receipts/MNEME_P2.3_Local_AB_Reasoning_Off_Truncated_20260925.json)). Four of eight final responses reached the shared 96-token limit. The corrected v2 schedule raises that shared allowance to 256 tokens and is frozen in [the schedule receipt](receipts/MNEME_P2.3_Matched_Twin_AB_Schedule_v2_20260925.md).

* The v2 local readout is preserved in [the 256-token stop receipt](receipts/MNEME_P2.3_Local_AB_Output_256_Truncated_20260925.md) ([raw results](receipts/MNEME_P2.3_Local_AB_Output_256_Truncated_20260925.json)). Seven responses were usable; M0 still hit the bound. The final v3 schedule raises the shared allowance to 384 tokens and is frozen in [the schedule receipt](receipts/MNEME_P2.3_Matched_Twin_AB_Schedule_v3_20260925.md).

* The final eight-call local M/C readout is preserved in [the v3 raw evidence receipt](receipts/MNEME_P2.3_Local_AB_v3_Raw_20260925.md) ([JSON](receipts/MNEME_P2.3_Local_AB_v3_Raw_20260925.json)). All local processes returned non-empty text; M selected the credited route only for the first two garden/paint probes, while C selected none and unrelated controls selected none for both.

* The first blinded evaluator invocation is preserved as [invalid label-map evidence](receipts/MNEME_P2.3_Blinded_Evaluator_Invalid_Label_Map_20260925.md) ([JSON](receipts/MNEME_P2.3_Blinded_Evaluator_Invalid_Label_Map_20260925.json)). Both labels accidentally contained control responses; no result was used. The same fixed local responses are re-evaluated after an offline mapping correction.

* The corrected [matched-twin readout report](receipts/MNEME_P2.3_Matched_Twin_AB_Report_20260925.md) ([JSON](receipts/MNEME_P2.3_Matched_Twin_AB_Report_20260925.json)) records eight local Gemma responses and two corrected blinded Qwen evaluator calls. The exploratory disposition is `POSSIBLE_DIFFERENCE`; no developmental or evaluation writeback occurred.

* The consolidated [specialist-instrument final disposition](receipts/MNEME_P2.3_Specialist_Instrument_Final_Disposition_20260925.md) ([JSON](receipts/MNEME_P2.3_Specialist_Instrument_Final_Disposition_20260925.json)) separates measurement/consolidation (`MEASUREMENT_RECOVERED_NO_CONSOLIDATION`) from the exploratory behavioral A/B (`POSSIBLE_DIFFERENCE`). P2.3 remains waiting for review; Phase Two is not closed.

* The final cross-thread continuity experiment is recorded in [the v6 receipt](receipts/MNEME_P2.3_Cross_Thread_Continuity_v6_Receipt.md) ([JSON](receipts/MNEME_P2.3_Cross_Thread_Continuity_v6_Receipt.json)) with its complete sanitized [evidence tree](receipts/MNEME_P2.3_Cross_Thread_v6_Evidence/). The corrected learner-eligible readout found no eligible MNEME route, so the conservative result is `INCONCLUSIVE`; historical v6 artifacts remain unchanged.

* The additive [episodic provenance decision](decisions/MNEME_P2_Episodic_Provenance_Addendum.md) adds deterministic conversation-arc records, source-role/outcome retention, external-versus-model re-entry handling, and the bounded two-round model-origin refractory rule without altering turn history or learner coefficients. The preserved v6 records are audited in [the episodic provenance audit](receipts/MNEME_P2.3_Cross_Thread_v6_Episodic_Provenance_Audit_20260926.md) ([JSON](receipts/MNEME_P2.3_Cross_Thread_v6_Episodic_Provenance_Audit_20260926.json)); the amended audit remains inconclusive and awards no retroactive credit.
  The derived [v6 arc rebuild](receipts/MNEME_P2.3_Cross_Thread_v6_Derived_Arc_Rebuild_20260926.md) makes the conservative thread-level grouping and same-arc duplicate decision explicit; it changes no historical learner state or disposition.
  The [provenance-group correction receipt](receipts/MNEME_P2.3_Provenance_Group_Correction_Receipt_20260926.md) records the source-identity fix, offline validation, and the remaining production arc-integration limitation.
  The [production arc-integration receipt](receipts/MNEME_P2.3_Episodic_Production_Arc_Integration_Receipt_20260926.md) records the runner/adapter wiring, idempotent arc publication, feedback-role correction, and fresh offline validation; historical v6 evidence remains unchanged.
  The [migration and arc regression receipt](receipts/MNEME_P2.3_Migration_And_Arc_Regression_Receipt_20260926.md) records direct schema 10→11 migration coverage and the FakeHost runner publication assertion; no provider calls were made.
  The [engineering-evidence hardening receipt](receipts/MNEME_P2.3_Engineering_Evidence_Hardening_Receipt_20260926.md) records full writable-lineage evaluation isolation, run-bound Phase Two artifact digests, and the durable engineering-adequacy audit at `c8565c4`; P2.3 remains waiting on scientific adequacy and accounting review.

  The [engineering-audit closure hardening receipt](receipts/MNEME_P2.3_Engineering_Audit_Closure_Hardening_Receipt_20260926.md) records prepared subject/permission snapshots, exact replay verification, strict schedule-coordinate and host-binding checks, and fresh validation at `ea1c918`; no provider calls were made and P2.3 remains waiting on scientific adequacy and accounting review.
  The [run-bound engineering audit receipt](receipts/MNEME_P2.3_Run_Bound_Engineering_Audit_20260926.md) ([JSON](receipts/MNEME_P2.3_Run_Bound_Engineering_Audit_20260926.json)) applies those checks read-only to the preserved q→r continuation artifacts. It records the split-inventory and missing historical snapshot evidence explicitly; it does not claim an engineering pass or alter the historical `COMPLETED_INADEQUATE` result.
  The [current budget/accounting audit](receipts/MNEME_P2.3_Budget_Accounting_Current_Audit_20260926.md) ([JSON](receipts/MNEME_P2.3_Budget_Accounting_Current_Audit_20260926.json)) reconciles 456 attempted/returned calls and 455 persisted results, including the one lost provider return. The factual ledger is closed; the 57-call overage above the recorded 399-call cap remains an authority-review issue.

  The [final episodic recurrence preflight](receipts/MNEME_P2.3_Final_Episodic_Preflight_20260926.md) ([JSON](receipts/MNEME_P2.3_Final_Episodic_Preflight_20260926.json)) freezes the two-branch, 30-turn Schema 11 mechanism schedule. It preserves all historical evidence and supplies five spaced target opportunities so the fixed learner's consolidation gap and rolling cap are exercised without changing learner semantics.

  Run 3 of that final schedule is preserved as [an invalid harness stop](receipts/MNEME_P2.3_Final_Episodic_Run3_Invalid_20260926.md) ([JSON](receipts/MNEME_P2.3_Final_Episodic_Run3_Invalid_20260926.json)): four calls for the first coordinate returned and persisted, then a transcript publication API error stopped the run before any later coordinate. No scientific result was assigned.

  Run 4 is preserved as [an invalid envelope stop](receipts/MNEME_P2.3_Final_Episodic_Run4_Invalid_20260926.md) ([JSON](receipts/MNEME_P2.3_Final_Episodic_Run4_Invalid_20260926.json)): the first branch consumed the erroneous 100-call envelope before its final coordinate. The corrected preflight binds a 300-call hard bound for at most 240 frozen schedule role calls; no scientific result was assigned.

  Run 5 is preserved as [an invalid process-supervision stop](receipts/MNEME_P2.3_Final_Episodic_Run5_Invalid_Supervision_20260926.md) ([JSON](receipts/MNEME_P2.3_Final_Episodic_Run5_Invalid_Supervision_20260926.json)): the external branch reached turn 26 and persisted its partial provider/local artifacts, then the launcher terminated before publication/assessment and before the model branch began. No scientific result was assigned; a fresh run ID is required.

  Run 6 is preserved as [an invalid remote-decode stop](receipts/MNEME_P2.3_Final_Episodic_Run6_Invalid_UTF8_20260926.md) ([JSON](receipts/MNEME_P2.3_Final_Episodic_Run6_Invalid_UTF8_20260926.json)): the external branch completed, then local Gemma development at model turn 12 raised a strict UTF-8 decode error before result persistence. No scientific result was assigned; the adapter correction is limited to replacement decoding and requires a fresh run ID.

  Run 7 is preserved as [an invalid provider-rate-limit stop](receipts/MNEME_P2.3_Final_Episodic_Run7_Invalid_RateLimit_20260926.md) ([JSON](receipts/MNEME_P2.3_Final_Episodic_Run7_Invalid_RateLimit_20260926.json)): the external branch completed and the model branch reached turn 26, then DeepInfra returned HTTP 429 at the next participant coordinate. No downstream work was dispatched; recovery is limited to that coordinate in a copied workspace.

  The bounded recovery then completed the fixed schedule as `NOT_DEMONSTRATED`: [the final result receipt](receipts/MNEME_P2.3_Final_Episodic_Run7_Recovery_Result_20260926.md) ([JSON](receipts/MNEME_P2.3_Final_Episodic_Run7_Recovery_Result_20260926.json)) records 220 returned role calls, 30 turns per branch, zero consolidation transitions, and the unchanged learner rules. The complete sanitized request/result, transcript, extraction, assessment, learner, and manifest bundle is [published here](receipts/MNEME_P2.3_Final_Episodic_Run7_Recovery_Evidence/).

  The Phase Two bookend is [the final scientific disposition](receipts/MNEME_Phase_Two_Final_Disposition_20260926.md) ([JSON](receipts/MNEME_Phase_Two_Final_Disposition_20260926.json)). It records engineering/runtime acceptance with limitations, specialist extraction findings, episodic/provenance behavior, the final `NOT_DEMONSTRATED` consolidation result, earlier exploratory/inconclusive studies, preserved invalid attempts, and an explicit Phase Three boundary.
  The first local-assessor A/B attempt is preserved as an invalid control permission stop in [the control permission receipt](receipts/MNEME_P2.3_Shared_Interloper_Control_Permission_Stop_20260926.md) ([JSON](receipts/MNEME_P2.3_Shared_Interloper_Control_Permission_Stop_20260926.json)); no behavioral result was assigned.

  The first fully executing local-assessor run is preserved as `INVALID_NO_TREATMENT`: canonical IDs reached the assessor instead of source-language labels, so no MNEME influence formed. See the [no-treatment diagnosis receipt](receipts/MNEME_P2.3_Shared_Interloper_No_Treatment_20260926.md) ([JSON](receipts/MNEME_P2.3_Shared_Interloper_No_Treatment_20260926.json)).

  The pinned local DeBERTa assessor passed production-shaped Q1/Q2/Q3 and a separate held-out ten-item semantic set on the MSI CPU path. See the [local NLI assessor qualification receipt](receipts/MNEME_P2.3_Local_NLI_Assessor_Qualification_20260926.md) ([JSON](receipts/MNEME_P2.3_Local_NLI_Assessor_Qualification_20260926.json)); no DeepInfra calls were made for qualification.

  The final evidence inventory was independently checked in [the artifact verification receipt](receipts/MNEME_P2.3_Final_Episodic_Artifact_Verification_20260926.md) ([JSON](receipts/MNEME_P2.3_Final_Episodic_Artifact_Verification_20260926.json)): 281 declared artifacts, zero missing, zero mismatched, and matching run-manifest/index digests.

  The first prospective run using that qualified local assessor is preserved as [an invalid no-treatment stop](receipts/MNEME_P2.3_Shared_Interloper_Local_Assessor_No_Treatment_20260926.md) ([JSON](receipts/MNEME_P2.3_Shared_Interloper_Local_Assessor_No_Treatment_20260926.json)). The specialist admitted a supported relationship and formed learner state, but the frozen schedule selected no MNEME route at any coordinate, so no behavioral A/B result was assigned.

  The route-selection diagnosis and instrumentation-only treatment-delivery preflight are recorded in [the route reachability preflight receipt](receipts/MNEME_P2.3_Treatment_Delivery_Preflight_20260926.md) ([JSON](receipts/MNEME_P2.3_Treatment_Delivery_Preflight_20260926.json)). It identifies the r6 loss at exact query coverage and proves that a known eligible learned state now reaches route selection, memory construction, and application without changing historical evidence.

  The corrected prospective r7 run is preserved as [a second invalid no-treatment receipt](receipts/MNEME_P2.3_Shared_Interloper_R7_Invalid_No_Treatment_20260926.md) ([JSON](receipts/MNEME_P2.3_Shared_Interloper_R7_Invalid_No_Treatment_20260926.json)), with its complete sanitized evidence bundle in [the r7 evidence directory](receipts/MNEME_P2.3_Shared_Interloper_R7_Invalid_No_Treatment_Evidence/). Route plumbing passed preflight, but the stochastic frozen trajectory never supplied a later relevant external query; no behavioral result was assigned.
